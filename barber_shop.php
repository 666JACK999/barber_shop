                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a href="citas.php">Reservas</a></li>
            ...
            <div id="rev_slider_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.0.7">
                <ul>
                    ...
                    <li data-index="rs-3" data-transition="slideoververtical">
                        <!-- MAIN IMAGE -->
                        <img src="assets/images/slideshow/slide-1.jpg" alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <img src="assets/images/slideshow/slide-2.jpg" alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        ...
                        <div class="tp-caption Photography-Display tp-resizeme" id="slide-3-layer-2" 
                            ...
                            style="z-index: 6; white-space: nowrap; font-family: Playfair Display;">BARBERIA</div>
                        ...
                        <div class="tp-caption Photography-Display tp-resizeme" id="slide-3-layer-3" 
                            ...
                            style="z-index: 7; white-space: nowrap; color: #bc9355; font-family: Playfair Display;">BARBERIA
                        </div>
                ...
                <div class="row mb30">
                    <div class="col-md-12">
                        <div class="footer-logo">
                            <img src="img/cuevas.jpg" alt="" class="img-center img-responsive">
                        </div>
                    </div>
                </div>
                <div class="row mb30">
                    <div class="col-md-5 col-sm-5">
                        <div class="footer-contact text-right">
                            <p>Telefono: +52 631 189 55 00</p>
                            <p>E-mail: <a href="http://sitetemplate.demo.ithemeslab.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="533a3d353c132a3c2621373c3e323a3d7d303c3e">16340614@itnogales.edu.mx</a></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5 col-sm-5">
                        <div class="footer-contact text-left">
                            <p>Nogales/Sonora</p>
                            <p>Avenida Tecnológico #237 Local 1 Colonia La Granja, Heroica Nogales, 84065</p>
                            <p>⏰Horario de atención de 10 a.m. a 8p.m.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer-social">
                            <ul>
                                <li><a href="https://www.facebook.com/BarberShopCuevas" target="_black"><i class="fa fa-facebook"></i></a></li>
                                <!--<li><a href="https://www.youtube.com/channel/UC87BrnQy7Y6iipGvQ6sAJfQ" target="_black"><i class="fa fa-youtube"></i></a></li>-->
                                <li><a href="https://www.instagram.com/_cuevasbarbershop_/" target="_black"><i class="fa fa-instagram"></i></a></li>
                                <li><a href="https://www.google.com.mx/maps/place/Cuevas+Barber+Shop/@31.3061213,-110.9482771,17z/data=!3m1!4b1!4m5!3m4!1s0x86d15391d2132765:0xb9ac237cdca3e39f!8m2!3d31.3061172!4d-110.946092" target="_black"><i class="fa fa-google-plus"></i></a></li>
