...
<html>
  ...
  <link rel="stylesheet" href="./style.css">
	...
	<body>
 <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/es_LA/sdk.js#xfbml=1&version=v11.0" nonce="dvQeBcfn"></script>
<section id="slide">
					...
					<div id="form">
						...
						<form name="cotacto" method="POST" action="#">
							...
							<script type="text/javascript">
								function alerta(){
									alert("Gracias por ponerte en contacto con nosotros, pronto nos pondremos en contacto contigo!!");
								}
							</script>
